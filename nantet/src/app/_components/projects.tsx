...
export default function HeroPilates() {
    ...
    return (
        <div
            ...
            data-aos="fade-up"
        >
            {/* Player embed do Cloudinary */}
            <Parallax speed={-20} className="absolute inset-0">
                <iframe
                    src="https://player.cloudinary.com/embed/?cloud_name=dutbdeta6&public_id=nantet2_pdbn4s&profile=cld-default&autoplay=true&muted=true&loop=true&controls=false"
                    className="w-full h-full object-cover pointer-events-none"
                    ...
                    title="Vídeo de background - Pilates"
                />
            </Parallax>
            ...
            <div className="absolute inset-0 bg-black/40 flex flex-col items-center justify-center z-10 px-4 space-y-8">
                ...
                >
                    <a
                        href="https://wa.me/556182795960?text=Olá%20Carolina.%20Gostaria%20de%20mais%20informações%20sobre%20as%20aulas%20de%20Pilates."
                        target="_blank"
                        rel="noopener noreferrer"
                        className="bg-[#25D366] text-white flex items-center justify-center gap-3 px-6 sm:px-8 py-3 sm:py-4 rounded-full shadow-lg hover:bg-[#128C7E] transition-colors duration-300 text-base sm:text-lg font-medium"
                        aria-label="Entrar em contato no WhatsApp"
